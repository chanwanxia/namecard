    ...
    <main className="page-shell">
      ...
      <section className="hero-section">
        ...
        <div className="hero-visual">
          <div className="visual-card">
            <img src={avatarIllustration} alt="Cartoon illustration of Judy as a frontend developer" />
          </div>
        </div>
      </section>
      ...
      <section className="info-grid">
        <article className="info-panel">
          ...
          <p>
            Judy focuses on common configuration and foundational frontend modules, shaping
            stable interfaces that feel simple on the surface and dependable underneath.
          </p>
        </article>
